...
INSTRUCTION_ACCESS_DELETE_ON_EXPIRE = "delete-on-expire"
INSTRUCTION_ACCESS_EMAIL_ATTACH_FILES = "email-attach-files"
...
EVENT_DEFAULT_VALUES = {
    ...
    EventField.INSTRUCTION.value: f'{{"{EventInstructionAttribute.PROCESS.value}": ["{EventInstructionProcess.RECORD.value}"], "{EventInstructionAttribute.POSTPROCESS.value}": [{{"{EventInstructionPostprocess.UPLOAD.value}": {{"{INSTRUCTION_UPLOAD_KEY_DELETE}": true}}}}]}}'
}
