...
ffmpeg -hide_banner -loglevel error -stats -y -i "$input_file" -vn -acodec libmp3lame "$audio_file"

whisper-ctranslate2-remote-api "$audio_file" --output_dir "$input_dir" --faster_whisper_api_base_url http://host.docker.internal:9876/api/v0
